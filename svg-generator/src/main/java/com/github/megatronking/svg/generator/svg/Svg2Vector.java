...
public class Svg2Vector {
     ...
     */
    public static String parseSvgToXml(File inputSVG, File outputVector, int width, int height, boolean applyTint) {
        // Check input params.
        ...
        try {
            ...
            Svg2VectorTemplateWriter writer = new Svg2VectorTemplateWriter(svg, applyTint);
    ...
    public static String parseSvgToXml(File inputSVG, OutputStream outputStream, int width, int height, boolean applyTint) {
        // Check input params.
    ...
    public static String parseSvgToXml(InputStream inputStream, OutputStream outputStream, int width, int height, boolean applyTint) {
        // Check input params.
