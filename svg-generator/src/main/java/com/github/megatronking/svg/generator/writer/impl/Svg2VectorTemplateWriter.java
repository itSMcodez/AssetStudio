...
public class Svg2VectorTemplateWriter implements IBufferWriter {
    ...
    public Svg2VectorTemplateWriter(Svg svg, boolean applyTint) {
        this.mSvg = svg;
    ...
    public void write(BufferedWriter bw) throws IOException {
        ...
        bw.newLine();
        String shouldCloseNode = applyTint ? "\"" : "\">";
        bw.write(HEAD_INDENT + "android:viewportWidth=\"" + FloatUtils.format2String(mSvg.viewBox[2]) + shouldCloseNode);
        bw.newLine();
        if(applyTint) {
            bw.write(HEAD_INDENT + "android:tint=\"" + "?attr/colorControlNormal" + "\">");
            bw.newLine();
        }
